...
<body>
	<div class="whole" id="whole">
			...
			<ul class="nav nav-tabs" style="font-size: 1.2vmax;background-color: #ffae42;">
				...
				<li class="nav-item">
					<a class="nav-link active" href=""
						style="border-top: 5px solid #171790;background-color: #ffe2ba;">Admissions</a>
				</li>
			</ul>
		...
		<div style="margin: 2vh 3vw;">
			...
			<!-- <p style="font-size: 1.5vmax;font-weight: bold;text-align: center;">
				Fee to be paid once at admission:
			</p>
			<table style="margin: auto">
				<tr>
					<td>Placement Counseling Fees </td>
					<td> : Rs. 1000</td>
				</tr>
				<tr>
			...
			<p style="font-size: 1.5vmax;font-weight: bold;text-align: center;margin-top: 3vh;">
				Annual Fee:
			</p>
			<table style="margin: auto">
				<tr>
				...
				<tr>
					<td>Students Society Fee </td>
					<td>: Rs. 200</td>
				</tr>
				<tr>
					<td>Student Hostel Maintenance Fund </td>
					<td>: Rs. 1500</td>
				</tr>
				<tr>
					<td>E-mail/Internet Fee (CCF) </td>
					<td>: Rs. 1000</td>
				</tr>
				<tr>
					<td>Computer Charge and Stationary Fee </td>
					<td>: Rs. 500</td>
				</tr>
				<tr>
					<td>Med Claim </td>
			...
			<table style="margin: auto">
				...
				<tr>
					<td>(i) Single Seated Rooms</td>
					<td> : Rs. 1500</td>
				</tr>
				<tr>
					<td>(ii) Double Seated Rooms</td>
					<td> : Rs. 1000</td>
				</tr>
				<tr>
					<td>(iii) Triple Seated Rooms</td>
					<td> : Rs. 750</td>
				</tr>
				<tr>
					<td>Water Charges</td>
