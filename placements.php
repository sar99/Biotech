...
<body>
	<div class="whole" id="whole">
			...
			<ul class="nav nav-tabs" style="font-size: 1.2vmax;background-color: #ffae42;">
				...
				<li class="nav-item">
					<a class="nav-link active" href=""
						style="border-top: 5px solid #171790;background-color: #ffe2ba;">Placements</a>
				</li>
				<li class="nav-item">
		...
		<div style="text-align: center;margin-top: 5vh;margin-bottom: 2vh;">
			<h3 style="font-family: 'Anton', sans-serif;">Previous Placements in companies like</h3>
		</div>
		...
		<div style="text-align: center;margin-top: 5vh;margin-bottom: 2vh;">
			<h3 style="font-family: 'Anton', sans-serif;">Students go for higher education in Institues like</h3>
		</div>

		<div class="card-group" style="margin-left: 10vw; margin-right: 10vw;margin-bottom: 3vh;text-align: center;">
			<div class="card">
				<img src="./img/stanford.jpeg" class="card-img-top"
					style="height: 8vw;width: 7vw;text-align: center;margin: auto;">
			</div>
			<div class="card">
				<img src="./img/illinois.jpg" class="card-img-top"
					style="height: 8vw;width: 7vw;text-align: center;margin: auto;">
			</div>
			<div class="card">
				<img src="./img/harvard.png" class="card-img-top"
		...
		<div style="display: flex;justify-content: space-evenly;flex-wrap: wrap;">
			...
			<div style="max-width: 50vw;">
				<div style="text-align: center;margin-top: 5vh">
					<h3 style="font-family: 'Anton', sans-serif;">Procedure for Placement</h3>
				</div>
				<ul class="timeline" style="font-size: 2.2vh;;">
					<li>
						<div class="item">
							<span>1</span>
							<div class="content">
					...
					<li>
						<div class="item">
							<span>2</span>
							<div class="content">
								<p>Prospective employers intimate the Director about their human resource requirements
									in
									various disciplines running in the University.</p>
							</div>
						</div>
					</li>
					<li>
						<div class="item">
							<span>3</span>
							<div class="content">
								<p>The Directorate there upon invites the bio-data of interested students and pass on to
									the
					...
					<li>
						<div class="item">
							<span>4</span>
							<div class="content">
								<p>A mutually agreed date for holding interviews either at the university campus or
									employers' head-quarters is fixed and the candidates are directed accordingly.</p>
							</div>
						</div>
					</li>
					<li>
						<div class="item">
							<span>5</span>
							<div class="content">
								<p>For interviews held at Pantnagar, the University provides free boarding and lodging
									facilities to the members of the Selection Committee in the University.</p>
							</div>
						</div>
					</li>
					<li>
						<div class="item">
							<span>6</span>
							<div class="content">
								<p>Besides recruitment related activities, companies are welcome to visit for
									academia-industry interface and meet faculty members for exploring new areas of
									collaboration in research and consultancy projects.</p>
							</div>
						</div>
					</li>
				</ul>
				...
				<div>
					<div style="text-align: center;margin-top: 5vh;margin-bottom: 2vh;">
						<h3 style="font-family: 'Anton', sans-serif;">Star Achievers</h3>
					</div>
				</div>
				<div style="display: flex;justify-content: space-evenly;flex-wrap: wrap;">
					<div style="display: flex;flex-direction: column; margin: 5px;">
						<div><img src="img/shashank.jpg" width="200vmax" height="200vmax"
								style="border-radius: 50%;border: 7px solid #ffe2ba;"></div>
						<div style="padding-top: 2vh;text-align: center;">
							<p style="margin-bottom: 3px;font-size: 2vh;"><b>Shashank Garg</b></p>
							<p style="margin-bottom: 3px;font-size: 1.8vh;">Senior Physics Faculty</p>
							<p style="margin-bottom: 3px;font-size: 1.8vh;">Allen Career Institute, Jaipur</p>
						</div>
					</div>
					<div style="display: flex;flex-direction: column; margin: 5px;">
						<div><img src="img/sonakshi.jpg" width="200vmax" height="200vmax"
								style="border-radius: 50%;border: 7px solid #ffe2ba;"></div>
						<div style="padding-top: 2vh;text-align: center;">
							<p style="margin-bottom: 3px;font-size: 2vh;"><b>Sonakshi Arya</b></p>
							<p style="font-size: 1.8vh;">IIM Ahmedabad</p>
						</div>
					</div>
				</div>
			</div>
			...
			<div style="display: flex;flex-direction: column;">
				...
				<div style="text-align: center;margin-top: 5vh;margin-bottom: 2vh;">
					<h3 style="font-family: 'Anton', sans-serif;">Our Googlers</h3>
				</div>
				<div class="past" id="past" style="display: flex;flex-direction: column;font-size: 2vh;">


					<div style="display: flex;flex-direction: column;">
						<div><img src="img/diksha_kandpal.jpg" width="200vmax" height="200vmax"
								style="border-radius: 50%;border: 7px solid #ffe2ba;"></div>
						<div style="padding-top: 2vh;text-align: center;">
							<p><b>Diksha Kandpal</b></p>
						</div>
					</div>
					<div style="display: flex;flex-direction: column;">
						<div><img src="img/kritik_kumar.jpeg" width="200vmax" height="200vmax"
								style="border-radius: 50%;border: 7px solid #ffe2ba;"></div>
						<div style="padding-top: 2vh;text-align: center;">
							<p><b>Kritik Kumar</b></p>
						</div>
					</div>
					<div style="display: flex;flex-direction: column;">
						<div><img src="img/megha_bisht.jpg" width="200vmax" height="200vmax"
								style="border-radius: 50%;border: 7px solid #ffe2ba;"></div>
						<div style="padding-top: 2vh;text-align: center;">
							<p><b>Megha Bisht</b></p>
						</div>
